...
// in trivia_number/test/features/presentation/bloc/number_trivia_bloc_test.dart.
...
import 'package:trivia_number/core/error/failures.dart' as _i6;
import 'package:trivia_number/core/usecases/usecase.dart' as _i9;
import 'package:trivia_number/core/util/input_converter.dart' as _i10;
...
class MockInputConverter extends _i1.Mock implements _i10.InputConverter {
  ...
  @override
  _i3.Either<_i6.Failure, int> stringToUnsignedInterger(String? str) =>
      (super.noSuchMethod(
        Invocation.method(
          #stringToUnsignedInterger,
          [str],
        ),
